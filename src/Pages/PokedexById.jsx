    ...
    <div>
      ...
      <div className="pokedexid__container">
        <article className="pokedexid__article">
          <header
            className={`pokedexid__header bg-${pokemon?.types[0].type.name}`}
          >
            <img
          ...
          <h1
            className={`pokedexid__number letter-${pokemon?.types[0].type.name}`}
          >
            #{pokemon?.id}{" "}
          </h1>
          <div className="pokedexid__name-container">
            ...
            <h2
              className={`pokedexid__name letter-${pokemon?.types[0].type.name}`}
            >
              {" "}
              {pokemon?.name}
            </h2>
          ...
          <section className="pokedexid__body">
            <ul className="pokedexid__descrip-container">
              <li className="pokedexid__weight">
                {" "}
                <strong>Weight</strong>
                <span className="pokedexid__weight-span">
                  {" "}
            ...
            <ul className="pokedexid__type-container">
              ...
              <div className="pokedexid__types">
                {pokemon?.types.map((type) => (
                  <li className="pokedexid__type" key={type.type.name}>
                    {" "}
                    <span
                      className={`pokedexid__types-span bg-${type.type.name}`}
                    >
                      {" "}
                      {type.type.name}
                    </span>
            ...
            <ul className="pokedexid__ability-container">
              ...
              <div className="pokedexid__abilities">
                {pokemon?.abilities.map((ability) => (
                  <li className="pokedexid__ability" key={ability.ability.name}>
          ...
          <div className="pokedexid__stats-title-container">
            <div className="pokedexid__stats-title">
              {" "}
              <h1>Stats</h1>
            </div>
              ...
              {pokemon?.stats.map((stat, i) => (
                <li key={i}>
                  <span className="pokedexid__stat-span">
                    <span className="pokedexid__stat-name">
                      {stat.stat.name}
                      {""}
                    </span>
                    <span className="pokedexid__stats-numbers">
                      {stat.base_stat}/{"150"}
                    </span>
                  </span>
      ...
      <div className="pokedexid__move-container">
        <article className="pokedexid__move-article">
          <div className="pokedexid__stats-title-container">
            <div className="pokedexid__move-title">
              {" "}
              <h1>Movements</h1>
            </div>
          ...
          <ul className="pokedexid__move">
            {pokemon?.moves.map((move) => (
              <li className="pokedex__move-name" key={move.move.name}>
